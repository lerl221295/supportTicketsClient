...
import GetTecnicos from '../../graphQL/querys/agents.graphql'
...
class TicketDetails extends Component {
	...
	componentWillReceiveProps = async (props) => {
		/*cuando la data del ticket llegue, se deben buscar los agents para
		...
		if(!props.data.loading && !props.data.error){
			if(!props.data.ticket.tecnico){
				...
				el ticket.estado != abierto), no debo pedir los demas agents*/
